...
public class LiquitSingularityFluidType extends FluidType {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("bloody:blocks/singularit_testure"),
					FLOWING_TEXTURE = new ResourceLocation("bloody:blocks/singularit_testure");
