...
package net.mcreator.bloodyhell.client.particle;
...
public class BlooddripParticle extends TextureSheetParticle {
	...
	public static class BlooddripParticleProvider implements ParticleProvider<SimpleParticleType> {
		...
		public Particle createParticle(SimpleParticleType typeIn, ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed,
				double zSpeed) {
			return new BlooddripParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
		}
	}
