...
package net.mcreator.testmod.world.features.lakes;
...
public class BloodFeature extends LakeFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("test_mod:blood", FEATURE,
				new LakeFeature.Configuration(BlockStateProvider.simple(TestModModBlocks.BLOOD.get()), BlockStateProvider.simple(Blocks.AIR)));
		PLACED_FEATURE = PlacementUtils.register("test_mod:blood", CONFIGURED_FEATURE,
