...
public class BloodSlimeEntity extends Slime {
	public BloodSlimeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(TestModModEntities.BLOOD_SLIME.get(), world);
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(TestModModItems.BLOOD_BALL.get()));
	}
	...
	public static void init() {
		SpawnPlacements.register(TestModModEntities.BLOOD_SLIME.get(), SpawnPlacements.Type.NO_RESTRICTIONS,
				Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
		DungeonHooks.addDungeonMob(TestModModEntities.BLOOD_SLIME.get(), 180);
	}
