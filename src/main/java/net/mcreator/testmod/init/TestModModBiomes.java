...
import net.mcreator.testmod.world.biome.BloodFieldsBiome;
...
public class TestModModBiomes {
	public static final DeferredRegister<Biome> REGISTRY = DeferredRegister.create(ForgeRegistries.BIOMES, TestModMod.MODID);
