...
import net.mcreator.testmod.fluid.BloodFluid;
import net.mcreator.testmod.TestModMod;

public class TestModModFluids {
	public static final DeferredRegister<Fluid> REGISTRY = DeferredRegister.create(ForgeRegistries.FLUIDS, TestModMod.MODID);
