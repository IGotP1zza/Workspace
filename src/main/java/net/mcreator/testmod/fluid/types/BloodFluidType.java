...
package net.mcreator.testmod.fluid.types;
...
public class BloodFluidType extends FluidType {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("test_mod:blocks/blood_still"),
					FLOWING_TEXTURE = new ResourceLocation("test_mod:blocks/blood_flow");
