...
import net.mcreator.testmod.procedures.BloodBallPlayerFinishesUsingItemProcedure;
...
public class BloodBallItem extends Item {
	public BloodBallItem() {
		super(new Item.Properties().tab(TestModModTabs.TAB_PIZZAS_TAB).stacksTo(64).rarity(Rarity.COMMON)
